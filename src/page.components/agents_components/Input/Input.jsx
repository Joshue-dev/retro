...
import {useSharedInputStyles} from '../../../ui-lib/ui-lib.hooks';
...
export const Input = ({isAuth, error, label, ...restProps}) => {
  const inputCommonStyles = useSharedInputStyles(isAuth);
  ...
  return (
    <VStack alignItems="flex-start" my={2} w="100%">
      ...
      <InputBase
        ...
        {...inputCommonStyles}
        onClick={handleLabel}
        borderColor={error ? 'red' : inputCommonStyles.borderColor}

...
import rightAngle from '/src/images/icons/right-angle.png';
import calendar from '/src/images/icons/schedule-icon.png';
  ...
  return (
    <>
      ...
      <Modal isOpen={offerDetails.isOpen} onClose={offerDetails.onClose}>
        <ModalOverlay />
        <ModalContent borderRadius="16px" minW="723px" px="30px">
          <ModalHeader pb="12px" fontSize={28} fontWeight={500} px="0">

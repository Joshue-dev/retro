import {Box, Divider, Flex, HStack, Stack, StackDivider, Text, VStack} from '@chakra-ui/react';
        ...
        >
          ...
          <Stack spacing="1px" flex={`1`}>
            <Text
              ...
              flexWrap={`wrap`}
            >
              {formatAmountWithDecimal(Number(listingDetail?.starting_from))}
            </Text>
            <Text
              fontWeight=" 400"
              fontSize={{base: '11px', lg: '14px'}}

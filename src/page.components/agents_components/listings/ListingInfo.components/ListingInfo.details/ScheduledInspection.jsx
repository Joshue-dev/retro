...
import scheduleIcon from '/src/images/icons/schedule-icon.png';
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <Stack>
          <Heading fontFamily='Euclid Circular B' fontWeight="500" fontSize="24px" lineHeight="30px" color="#191919">

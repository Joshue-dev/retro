            ...
            <Box w="full">
              ...
              >
                ...
                >
                  ...
                  . If any information is inaccurate, please initiate a dispute.
                  However, if all details are accurate, we kindly ask you to
                ...
                >
                  <VStack gap="0" align={"flex-start"}>
                    ...
                    <Text fontSize={"14px"} fontWeight={400} color="#525252">
                      Due{" "}
                      {moment(equityData?.next_due_date).format("MMM D, YYYY")}
                    </Text>
                  </VStack>
                ...
                {equityData?.purchase_date ? (
                  <Flex justify={"space-between"} align={"center"}>
                    ...
                    <Text
                      ...
                      fontWeight={600}
                    >
                      {moment(equityData?.purchase_date).format("MMM D, YYYY")}
                    </Text>
                  </Flex>
                ) : null}

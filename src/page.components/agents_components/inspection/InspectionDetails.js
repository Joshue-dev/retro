...
import PropertyInfo from '/src/page.components/agents_components/users/PropertyDetails';
  ...
  return (
    <VStack w="full" minW="888px" spacing="22px">
      <HStack w="100%" justify="space-between">
        <Heading fontFamily='Euclid Circular B' as="h1" fontSize="20px" fontWeight="700">
          Inspection History
        </Heading>

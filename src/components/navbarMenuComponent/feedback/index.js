...
import backIcon from "/src/images/icons/leftArrowWallet.svg";
import messageIcon from "/src/images/icons/feedbackIconAssets.svg";
...
export const Feedback = ({ bundleId, fromAssets, equityId }) => {
  ...
  const { data, isError, isLoading, error, refetch } = useQuery(
    ["feedbackhistory", equityId],
    () => getfeedbackHistory(equityId)
  );
  ...
  const feedbackMutation = useMutation(
    (formData) => feedback(formData, equityId),
    {
      onSuccess: async (res) => {
        await refetch();

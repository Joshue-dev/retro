...
import emptyFeedback from '/src/images/icons/empty_feedback.png';
import {InspectionFeedBack} from '/src/page.components/agents_components/users/inspection/InspectionFeedBack';
  ...
  return (
    ...
    >
      ...
      <VStack spacing="none" ml="21px" w="full" h="100%" alignSelf="start">
        <Heading fontFamily='Euclid Circular B' alignSelf="start" fontSize="32px" fontWeight="600">

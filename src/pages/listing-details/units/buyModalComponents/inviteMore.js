      ...
      {inviteMoreMutation.isSuccess ? (
        <Center mt="20px" w="full" h="full" flexDirection={'column'}>
          ...
          >
            ...
            <Button w="50%" h="48px" bg="primary" color="white" onClick={inviteMoreMutation.reset}>
              Invite Another User
            </Button>
          </Flex>
        </Center>
        ...
        <Box w="full">
          <Flex w="full" direction={'column'} align={'stretch'} gap={{base: '14px', md: '23px'}}>
            <Text fontSize={'23px'} fontWeight={400} className="gilda-display-regular">
              Invite a co-owner
            </Text>
            <Box w="full">
              <FormInput
                  ...
                  <>
                    {userData?.data?.data ? (
                      ...
                      <Flex gap="10px" align={'center'}>
                        <Icon color="#191919" fontSize={'17px'} as={BsExclamationCircle} />
                        <Text color="#191919" fontSize={'11px'}>
            ...
            <Box>
              <FormInput
                ...
                placeholder="0%"
              />
              <Text color="#A6A6A6" fontSize={'11px'}>{`${

          ...
          {HOME__OWNERS__PACKETS?.data?.data?.received?.map((item, index) => (
            <Flex key={index} align={'center'} justify={'space-between'} w='full' px='20px' py='18px' shadow={'md'} borderRadius={'12px'} border='1px solid #E4E4E4 !important'>
              <Flex align={'center'} gap='10px'>
                ...
                <VStack textAlign='start' align={'flex-start'} spacing='0'>
                  <Text fontSize={'15px'} fontWeight={500} fontFamily='optimaMedium' >document</Text>
              ...
              <a rel='noreferrer' target='_blank' href={item?.packet} >
                <Flex align={'center'} gap='10px'>
                  <Text fontSize={'14px'} color='#932128' fontWeight={400} fontFamily='optimaMedium' >View</Text>

              ...
              <Box w={'100%'} mx="auto">
                <Box position={'relative'} w="full">
                  ...
                  <AssetCarousel
                    ...
                    right="0"
                    leftItem={
                      <Text fontWeight={600} fontSize={'26px'} className="gilda-display-semibold">
                        {info?.unit?.unit_title}
                      </Text>
                    }
                    rightItem={
                      <Text fontWeight={500} fontSize={'26px'} className="gilda-display-medium">
                  ...
                  <GridItem colSpan={2}>
                    ...
                    >
                      <Box>
                        ...
                        <Text fontSize={'40px'} className="gilda-display-regular" mt="5px">

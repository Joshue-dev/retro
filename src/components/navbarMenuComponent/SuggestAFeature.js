...
import suggestAnIdeaIcon from "/src/images/icons/suggestAnIdeaIcon.svg";
...
export const SuggestAnIdea = () => {
  ...
  const suggestAFeatureMutation = useMutation(
    (formData) => suggestAFeature(formData, businessId),
    {
      onSuccess: (res) => {
        toaster(
          "Thank you for your suggestion! It's now in our review process."
        );
        handleClosedModal();
      },
      onError: (err) => {

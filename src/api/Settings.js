...
export const fetchAccounts = async () => {
  ...
  return await axios.get(
    `${BaseURL_TWO}/store/add-account/?accounts=true&store=${storeName}`
  );
};

export const fetchBanks = async () => {
  return await axios.get(`${BaseURL_TWO}/store/add-account/?banks=true`);
};

export const fetchSettings = async (data) => {
  return await axios.get(
    `${BaseURL_TWO}/store/store_settings`,
    `{  profile: true  }`
  );
};
...
// v2/store/store_settings
// payment_details=true&bank=trueaccoun
...
export const addBankAccount = async ({
  ...
  return await axios.post(`${BaseURL_TWO}/store/add-account/`, {
    account_number: accNum,
...
export const RemoveBankAccount = async (id) => {
  ...
  return await axios.delete(
    `${BaseURL_TWO}/store/store_settings/${id}?store_name=${storeName}&card=true`
  );
};

export const withdrawalPost = async ({ accNum, bankCode, amount }) => {
  return await axios.post(
    `${BaseURL_TWO}/store/add-account/
      {
      "account_number": ${accNum},
      "bank_code": ${bankCode},
      "amount":${amount}
...
export const getSettingsData = async (data) => {
  const storeName = store_name();

  return await axios.post(
    `${BaseURL_TWO}/store/store_settings?store_name=${storeName}`,
    data
  );
};
...
export const setUpRecurring = async (equityId, recurringPayload) => {
  return await axios.patch(
    `${BaseURL_TWO}/investment/equity/${equityId}/`,
    recurringPayload
  );
};

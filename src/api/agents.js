...
export const fetch_user_payment_breakdown_fractional = async (
  equity_id,
  user_id
) => {
  let response = [];
...
export const fetch_user_payment_breakdown_fractional_payments = async (
  user_id
) => {
  let response = [];
  const storeName = store_name();
...
export const fetch_user_payment_breakdown_autopay = async (
  equity_id,
  user_id
) => {
  let response = [];
...
export const fetch_user_payment_breakdown_upcoming_payments = async (
  equity_id,
  user_id
) => {
  let response = [];
  ...
  await agent_auth_fetch
    .get(
      `${BaseURL_ONE}/transaction/agent_upcoming?user=${user_id}&equity=${equity_id}`
    )
    .then((res) => (response = res));
  return response;
};
...
export const fetchAllListingBundles = async (projectId) => {
  ...
  await agent_auth_fetch
    .get(
      `${BaseURL_TWO}/investment/project-bundles/?project_id=${parseInt(
        projectId
      )}`
    )
    .then((res) => (response = res));
...
export const fetchAllCommissions = async (name) => {
  ...
  await agent_auth_fetch
    .get(
      `${BaseURL_TWO}/agents/transactions?type=commission&store_name=${storeName}`
    )
    .then((res) => (response = res));
  return response;
};
...
export const agentSignUp = async (form) => {
  ...
  await agent_auth_fetch
    .post(`${BaseURL_ONE}/user/agent`, data)
    .then((res) => (response = res));
  return response;
};
...
export const fetchOutrightContract = async (unitId) => {
  ...
  await agent_auth_fetch
    .get(
      `${BaseURL_TWO}/developers/project-documents?unit=${unitId}&purpose=outright`
    )
    .then((res) => (response = res));
  return response;
};
...
export const respondToInspectionFeedBack = (data, id) => {
  return agent_auth_fetch.post(
    `${BaseURL_TWO}/developers/project-inspection/${id}/`,
    data.body
  );
};

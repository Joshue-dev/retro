...
import { Popup } from "/src/ui-lib/ui-lib.components/Popup/Popup.jsx";
...
import reportABugIcon from "/src/images/icons/reportABugIcon.svg";
...
export const ReportABug = () => {
  ...
  const reportMutation = useMutation(
    (formData) => reportABug(formData, businessId),
    {
      onSuccess: (res) => {
          ...
          <DrawerBody p="0px">
            <Stack w="full" spacing="none">
              <Text
                ...
                color="#fff"
              >
                Encountered a bug? Let us know! Our team will investigate and
                work to resolve the issue ASAP.
              </Text>
              <Text
                textAlign="start"
                w="full"
